...
import { getUserProfiles ,subscribeToNewMatches,unsubscribeFromNewMatches} from '../features/matchesSlice';
...
const Home = () => {
  ...
  const { userProfiles, isLoadingUserProfiles } = useSelector((state) => state.matches);
  ...
  useEffect(() => {
    ...
    dispatch(subscribeToNewMatches());

    return () => {
      dispatch(unsubscribeFromNewMatches());
    };
  }, [dispatch]);
